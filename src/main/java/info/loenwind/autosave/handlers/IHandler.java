...
public interface IHandler<T> {
     ...
     * {@link #getHandler(Registry, Type)}.
     * 
     * @return The {@link Object#getClass()} this handler can handle.
     */
     ...
     * @param name
     *                 The name of the tag in the nbt where the data should be stored. Please note that this will be
     *                 overwritten by the final handler if you are
     ...
     *         <i>is</i> ok to partially handle an object and return false. This
     *         can be used to handle inheritance
     *
     * @throws IllegalAccessException   From reflection
     * @throws IllegalArgumentException From reflection
     * @throws InstantiationException   From reflection
     * @throws NoHandlerFoundException  If the handler could not be found
     */
    boolean store(Registry registry, Set<NBTAction> phase,
                  NBTTagCompound nbt, Type type,
                  String name, T object) throws IllegalArgumentException, IllegalAccessException,
                                         InstantiationException, NoHandlerFoundException;

    /**
     * Reads an object from a NBT structure
     * <p>
     * FIXME: This method will not be called if the saved value was null. It *will* be called if there is no saved
     * value, e.g. because the data is read from a
     * fresh itemstack. Creating an empty object in this case could be problematic, as the owner may not expect an empty
     * object. This case needs to be handled
     * better.
     * 
     * @param registry
     *                 The handler registry to use
     ...
     */
    @Nullable
    T read(Registry registry, Set<NBTAction> phase,
           NBTTagCompound nbt, Type type,
           String name, @Nullable T object) throws IllegalArgumentException, IllegalAccessException,
                                            InstantiationException, NoHandlerFoundException;
}
